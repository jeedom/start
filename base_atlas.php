		        ...
		        <div id="wizard">
				    ...
				    <div>
				    	<div class="row">
				    			...
				    			<h2><?=_("Etape 1 :");?></h2>
				    			<div class="thumbnail">
				    				<a data-toggle="lightbox" href="img/removeProtect.jpg"><img alt="router" src="img/removeProtect.jpg"  style="width: 250px;"></a>
				    		...
				    		<div class="col-md-3">
				    			<h2><?=_("Etape 3 :");?></h2>
				    			<div class="thumbnail">
				    				<a data-toggle="lightbox" href="img/connect-antenne-atlas.jpg"><img alt="antenne" src="img/connect-antenne-atlas.jpg"  style="width: 250px;"></a>
				    		...
				    		<div class="col-md-3">
				    			<h2><?=_("Etape 4 :");?></h2>
				    			<div class="thumbnail">
				    				<a data-toggle="lightbox" href="img/connect-power-ethernet-atlas.jpg"><img alt="power" src="img/connect-power-ethernet-atlas.jpg"  style="width: 250px;"></a>
