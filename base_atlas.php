	    	...
	    	<div class="col-md-12" align="center">
		        <div id="wizard">
				    ...
				    <div style="display:flex;flex-direction:column;width:100%;">
				    	<h3><?=_("Contenu de la boite :");?></h3>
				    	<div style="display:flex;justify-content:space-evenly;">
				    		<div class="divThumb">
				    			<div class="thumbnail flexThumb">
				    				<img alt="Atlas" src="img/atlas.jpg" style="width: 100px;">
				    				<div class="caption"><center>Jeedom Atlas</center></div>
				    			</div>
				    		</div>
				    		<div class="divThumb">
				    			<div class="thumbnail flexThumb">
				    		...
				    		<div class="divThumb">
				    			<div class="thumbnail flexThumb">
				    				<img alt="power-supply" src="img/power-supply_atlas.jpg"  style="width: 100px;">
				    				<div class="caption"><center><?=_("Alimentation");?></center></div>
				    			</div>
				    		</div>
								<div class="divThumb">
									<div class="thumbnail flexThumb">
										<img alt="power-supply" src="img/ethernet-cable.jpg"  style="width: 100px;">
										<div class="caption"><center><?=_("Cable Ethernet");?></center></div>
									</div>
								</div>
				    	</div>
				    	<h3><?=_("Ce dont vous avez besoin :");?></h3>
				    	<div style="display:flex;justify-content:space-evenly;">
				    		<div style="width: 40%;">
				    			<div class="thumbnail flexThumb">
				    ...
				    <div style="display:flex;justify-content:space-evenly;align-items:center;width:100%;height:100%;">
				    			...
				    			<div class="thumbnail flexThumbColumn">
				    				<a data-toggle="lightbox" href="img/removeProtect.jpg"><img alt="router" src="img/removeProtect.jpg"  style="margin-top:20%;height:181px;width: 250px;"></a>
				    				<div class="caption"><center><?=_("Retirez le film de protection");?></center></div>
				    			</div>
				    		</div>
				    		<div style="display:flex;flex-direction:column;justify-content:center;align-items:center;width: 50%;height:100%;">
				    			<h2><?=_("Etape 2 :");?></h2>
				    			<div class="thumbnail flexThumbColumn">
				    				<a data-toggle="lightbox" href="img/connect-router.jpg"><img alt="router" src="img/connect-router.jpg"  style="margin-top:20%;height:181px; width: 250px;"></a>
				    		...
				    		<div style="display:flex;flex-direction:column;justify-content:center;align-items:center;width: 50%;height:100%;">
				    			<h2><?=_("Etape 3 :");?></h2>
				    			<div class="thumbnail flexThumbColumn">
				    				<a data-toggle="lightbox" href="img/connect-antenne-atlas.jpg"><img alt="antenne" src="img/connect-antenne-atlas.jpg"  style="margin-top:20%;height:181px;width: 250px;"></a>
				    		...
				    		<div style="display:flex;flex-direction:column;justify-content:center;align-items:center;width: 50%;height:100%;">
				    			<h2><?=_("Etape 4 :");?></h2>
				    			<div class="thumbnail flexThumbColumn">
				    				<a data-toggle="lightbox" href="img/connect-power-ethernet-atlas.jpg"><img alt="power" src="img/connect-power-ethernet-atlas.jpg"  style="margin-top:20%;height:181px;width: 250px;"></a>
				    ...
				    <div style="display:flex;justify-content:space-evenly;width:100%;height:100%;">
				    		<div style="width: 33%;height:80%;">
				    			<h2><?=_("Etape 1 :");?></h2>
				    			<div class="thumbnail flexThumbColumn">
				    				<a href="https://market.jeedom.com" target="_blank"><img alt="market-logo" src="img/logo-MARKET.svg"  style="width: 250px;height: 117px;"></a>
				    		...
				    		<div style="width: 33%;height:80%;">
				    			<h2><?=_("Etape 3 :");?></h2>
				    			<div class="thumbnail flexThumbColumn">
				    				<a data-toggle="lightbox" href="img/service-pack.jpg"><img alt="service_pack" src="img/service-pack.jpg"  style="width: 250px;height: 117px;"></a>
