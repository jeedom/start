    	...
    	<div class="row" style="background: #96c927;">
	    	...
	    	<div class="col-md-5">
    			<div class="thumbnail">
    				...
    				<div class="caption"><center><b>Pack Jeedom Mini+ Z-Wave</b><br><a href="base.php?locale=<?php echo $locale; ?>&type=base" class="btn btn-primary"><?=_("Accéder au guide");?></a></center></div>
    			</div>
    		</div>
    		<div class="col-md-5">
    			<div class="thumbnail">
    				<img alt="sd-card" src="img/pack-zwave-rfxcom.jpg" style="width: 200px;">
    				<div class="caption"><center><b>Pack Jeedom Mini+ Z-Wave + Rfxcom</b><br><a href="base.php?locale=<?php echo $locale; ?>&type=rfxcom" class="btn btn-primary"><?=_("Accéder au guide");?></a></center></div>
    			</div>
    		</div>
    		<div class="col-md-1"></div>
    		...
    		<div class="col-md-5">
    			<div class="thumbnail">
    				...
    				<div class="caption"><center><b>Pack Jeedom Mini+ Enocean</b><br><a href="base.php?locale=<?php echo $locale; ?>&type=enocean" class="btn btn-primary"><?=_("Accéder au guide");?></a></center></div>
    			</div>
    		</div>
    		<div class="col-md-5">
    			<div class="thumbnail">
    				<img alt="power-supply" src="img/pack-enocean-rfxcom.jpg"  style="width: 200px;">
    				<div class="caption"><center><b>Pack Jeedom Mini+ Enocean + Rfxcom</b><br><a href="base.php?locale=<?php echo $locale; ?>&type=enocean_rfxcom" class="btn btn-primary"><?=_("Accéder au guide");?></a></center></div>
    			</div>
    		</div>
    		<div class="col-md-1"></div>
	    </div>
